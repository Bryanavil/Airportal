...
reserva.geometry("900x500+{}+{}".format(x, y))
...
# Etiqueta y Entry para ingresar el apellido
etiqueta_apellido = tk.Label(marco_central, text="Apellido")
etiqueta_apellido.grid(row=2, column=0, pady=5)  # Ajustar el espaciado

entry_apellido = tk.Entry(marco_central)
entry_apellido.grid(row=3, column=0, pady=(0, 20))  # Ajustar el espaciado
